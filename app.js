...
const Body = () => {
    return (
        ...
        {/* props = properties */}
            {/* <RestrauntCard {...restrauList[0].info}/>
            <RestrauntCard {...restrauList[1].info}/>
            <RestrauntCard {...restrauList[2].info}/>
            <RestrauntCard {...restrauList[3].info}/>
            <RestrauntCard {...restrauList[4].info}/>
            <RestrauntCard {...restrauList[5].info}/>
            <RestrauntCard {...restrauList[6].info}/> */}
            {
